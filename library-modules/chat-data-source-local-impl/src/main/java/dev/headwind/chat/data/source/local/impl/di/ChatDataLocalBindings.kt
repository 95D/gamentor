package dev.headwind.chat.data.source.local.impl.di
...
import dev.headwind.chat.data.source.local.impl.channel.ChatChannelLocalDataSourceImpl
import dev.headwind.chat.data.source.local.impl.message.ChatMessageLocalDataSourceImpl
